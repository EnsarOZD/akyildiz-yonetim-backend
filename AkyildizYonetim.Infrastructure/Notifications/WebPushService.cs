...
public class WebPushService : IWebPushService
{
    ...
    {
        _publicKey = configuration["WebPush:VapidPublicKey"] ?? throw new ArgumentNullException("WebPush:VapidPublicKey is missing");
        _privateKey = configuration["WebPush:VapidPrivateKey"] ?? throw new ArgumentNullException("WebPush:VapidPrivateKey is missing");
